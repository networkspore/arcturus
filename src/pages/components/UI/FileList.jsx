                                    ...
                                    if (rows != null && numColumns != 0) {
                                        ...
                                        if (!isNaN(rowIndex) && !isNaN(columnIndex)) {
                                            rows[rowIndex][columnIndex] = <div
                                                ...
                                                /><div style={{
                                                    boxShadow: iHash == selectedHash ? "0 0 10px #ffffff80" : "",
                                                    textShadow: iHash == selectedHash ? "1px 1px 3px black" : "", display: "flex", alignItems: "center", fontFamily: "webpapyrus", fontSize: "12", whiteSpace: "nowrap", padding: 5, background: iHash == selectedHash ? "#777777" : "", color: iHash == selectedHash ?"black" :"white", borderRadius:10 }}>
